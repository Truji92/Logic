...
\section*{Análisis por iteración}\addcontentsline{toc}{section}{Análisis por iteración}
	...
	En las tablas \ref{iteraciones10d4}, \ref{iteraciones14d4}, \ref{iteraciones16d3} \todo{meter algunas como ejemplo aquí o todas en un anexo?} se muestran algunas de estas ejecuciones en detalle.
